...
namespace Tracker.common
{
    public sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            //set timeout no limit amin shah
        ...
        public static DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText)
        {
            ...
            {
                //ApplicationQueriesLog.ApplicationQuriesLog.RecordQueryException(ex, commandText);
        ...
        internal static object ExecuteDataset(object connectionString, CommandType storedProcedure, string v)
        {
